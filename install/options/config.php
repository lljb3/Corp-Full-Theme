        ...
        public function setSections() {
			...
			**/
			...
			/* ==============================
				Header
			============================== */
			$options = get_options('kake_theme_option');
			$this->sections[] = array(
				...
				'fields'	=> array(
					...
					array(
						...
						'type' => 'color',
						'hidden' => ($options['transitional-header-button'] == 1) ? true : false,
					...
					array(
						...
						'type'	=> 'color',
						'title'	=> __('Site Header Link Color', 'redux-framework-demo'),
						'output'	=> array('header a,header a:visited,header a:focus,#header-container a,#header-container a:visited,#header-container a:focus,#trans-menu.small a,#trans-menu.small a:visited,#trans-menu.small a:focus'),
						'subtitle'	=> __('Site Header Link Color (default: #70b9a0)', 'redux-framework-demo'),
						'default'	=> '#70b9a0',
						'validate'	=> 'color',
						'transparent'	=> false,
            ...
            $this->sections[] = array(
	            ...
	            'fields' => array(
					...
					array(
						...
						'hidden' => ($options['content-posts-container'] == 1) ? true : false,
