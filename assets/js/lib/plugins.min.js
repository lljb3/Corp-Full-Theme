...
/* Smooth Scroll JS */
jQuery(document).ready(function($){$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=$(this.hash);if(a=a.length?a:$("[name="+this.hash.slice(1)+"]"),a.length)return $("html, body").animate({scrollTop:a.offset().top},1e3),!1}})});});
...
/* Aniview JS */
!function(a){var n=0;a.fn.scrolled=function(t,i){"function"==typeof t&&(i=t,t=200);var o="scrollTimer"+n++;this.scroll(function(){var n=a(this);clearTimeout(n.data(o)),n.data(o,setTimeout(function(){n.removeData(o),i.call(n[0])},t))})},a.fn.AniView=function(n){function t(n){var t=a(n).offset().top,i=a(window).scrollTop()+a(window).height();return t<i-o.animateThreshold?!0:!1}function i(n){a(n).each(function(n,i){var o=a(i).parent(".av-container");a(i).is("[data-av-animation]")&&!a(o).hasClass("av-visible")&&t(o)&&(a(i).css("opacity",1),a(o).addClass("av-visible"),a(i).addClass("animated "+a(i).attr("data-av-animation")))})}var o=a.extend({animateThreshold:0,scrollPollInterval:20},n),e=this;a(e).each(function(n,t){a(t).wrap('<div class="av-container"></div>'),a(t).css("opacity",0)}),i(e),a(window).scrolled(o.scrollPollInterval,function(){i(e)})}}(jQuery);

/* Rellax JS */
var DEBUG = false;var Rellax=function(e,t){var o=Object.create(Rellax.prototype);if("undefined"==typeof window.orientation){var n=0,s=0,r=[];if(o.options={speed:-4},t&&Object.keys(t).forEach(function(e){o.options[e]=t[e]}),-10>o.options.speed?o.options.speed=-10:10<o.options.speed&&(o.options.speed=10),e||(e="rellax"),document.getElementsByClassName(e.replace(".","")))o.elems=document.getElementsByClassName(e.replace(".",""));else{if(!1===document.querySelector(e))throw Error("The elements you're trying to select don't exist.");o.elems=querySelector(e)}var i=function(e){var t=0+e.getBoundingClientRect().top,n=e.clientHeight||e.offsetHeight||e.scrollHeight,r=e.dataset.rellaxSpeed?e.dataset.rellaxSpeed:o.options.speed,i=Math.round(100*r*(1-(0-t+s)/(n+s)));return e=e.style.cssText.slice(11),{base:i,top:t,height:n,speed:r,style:e}},l=function(){n=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop},a=function(){l();for(var e=0;e<o.elems.length;e++){var t="translate3d(0,"+(Math.round(100*r[e].speed*(1-(n-r[e].top+s)/(r[e].height+s)))-r[e].base)+"px,0)"+r[e].style;o.elems[e].style.cssText="-webkit-transform:"+t+";-moz-transform:"+t+";transform:"+t+";"}},d=0;return function(){s=window.innerHeight,l();for(var e=0;e<o.elems.length;e++){var t=i(o.elems[e]);r.push(t)}window.addEventListener("scroll",function(){a(),DEBUG?10>d?d++:(a(),d=0):a()}),window.addEventListener("resize",function(){a()}),a()}(),Object.freeze(),o}};